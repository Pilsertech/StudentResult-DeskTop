...
-- ============================================================
-- PHASE 2: ID CARD SYSTEM TABLES (Move before attendance)
-- ============================================================
...
-- ============================================================
-- PHASE 3: ATTENDANCE SYSTEM TABLES (Fixed order)
-- ============================================================

-- --------------------------------------------------------
--
-- Table structure for table `tblattendance_sessions` (Create FIRST)
...
-- --------------------------------------------------------
--
-- Table structure for table `tblattendance_settings` (Create SECOND)
...
-- --------------------------------------------------------
--
-- Table structure for table `tblattendance_reports` (Create THIRD)
...
-- --------------------------------------------------------
--
-- Table structure for table `tblattendance` (Create LAST)
...
-- ============================================================
-- INDEXES AND CONSTRAINTS (Apply at the END)
-- ============================================================
...
--
-- Constraints for dumped tables (Apply AFTER all tables are created)
--
...
-- ID Card Constraints
--
ALTER TABLE `tblidcard_generated`
  ADD CONSTRAINT `fk_generated_student` FOREIGN KEY (`StudentId`) REFERENCES `tblstudents` (`StudentId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_generated_template` FOREIGN KEY (`TemplateId`) REFERENCES `tblidcard_templates` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Attendance Constraints (Apply AFTER all attendance tables exist)
--
